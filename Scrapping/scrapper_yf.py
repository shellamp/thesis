...
# === CONFIG ===
QUERY = "site:finance.yahoo.com after:2025-01-10 before:2025-05-12"
NUM_RESULTS = 30
OUTPUT_FOLDER = "news_data/yahoo_search"
SOURCE_TAG = "yahoo"
...
try:
    for url in search(QUERY, num_results=NUM_RESULTS):
        if "finance.yahoo.com/news" in url and url not in article_urls:
