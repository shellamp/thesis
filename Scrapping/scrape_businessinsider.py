...
# === CONFIG ===
QUERY = "site:businessinsider.com after:2024-11-13 before:2025-02-11"
NUM_RESULTS = 30
OUTPUT_FOLDER = "news_data/businessinsider_search"
SOURCE_TAG = "businessinsider"
...
try:
    for url in search(QUERY, num_results=NUM_RESULTS):
        if "businessinsider.com" in url and re.search(r'-2025-\d{2}', url):
