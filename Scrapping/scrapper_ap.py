...
# === CONFIG ===
QUERY = "site:apnews.com/article after:2025-04-11 before:2025-05-5"
NUM_RESULTS = 30
OUTPUT_FOLDER = "news_data/apnews_search"
SOURCE_TAG = "apnews"
...
try:
    for url in search(QUERY, num_results=NUM_RESULTS):
        if "apnews.com/article" in url and url not in article_urls:
