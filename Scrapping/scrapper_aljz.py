...
# === CONFIG ===
QUERY = "site:aljazeera.com/news after:2025-04-11 before:2025-05-5"
NUM_RESULTS = 30
OUTPUT_FOLDER = "news_data/aljazeera_search"
...
try:
    for url in search(QUERY, num_results=NUM_RESULTS):
        if "aljazeera.com/news" in url and url not in article_urls:
